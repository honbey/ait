            ...
            div().class("flex items-center gap-1 sm:gap-3").children((
                {
                    ...
                    button()
                        .class(
                            "hidden sm:flex items-center gap-1.5 px-2 py-2 text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors text-sm",
                        )
                        .on(events::click, move |_| {
                ...
                div().class("hidden sm:block w-px h-6 bg-gray-200 dark:bg-gray-700 mx-1"),
                {
                    ...
                    View::from_dynamic(move || -> sycamore::web::View {
                        if !auth.get() {
                            ...
                            button()
                                .class(
                                    "flex items-center gap-2 px-3 py-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-sm text-gray-600 dark:text-gray-300",
                                )
                            ...
                            div()
                                ...
                                .children((
                                    div()
                                        .class(
                                            "flex items-center gap-2 cursor-pointer px-2 py-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors",
                                        )
                                        ...
                                        .children((
                                            ...
                                            span().class("hidden sm:inline text-sm text-gray-700 dark:text-gray-300")
                                                .children(View::from_dynamic(move || i18n_user.t("user"))),
                                            i().class(
