...
pub const CLASS_ICON_BTN: &str = "cursor-pointer text-gray-400 hover:text-gray-600 \
    dark:hover:text-gray-300 transition-colors active:scale-95";

// --- Buttons ---
pub const CLASS_BTN_CANCEL: &str = "px-4 py-2 text-sm text-gray-600 dark:text-gray-400 \
    hover:text-gray-800 dark:hover:text-gray-200 cursor-pointer transition-colors active:scale-95";
...
// --- Page ---
pub const CLASS_PAGE_TITLE: &str = "text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6";
pub const CLASS_NAV_LINK: &str = "flex items-center gap-2 px-3 py-2 cursor-pointer transition-colors \
    font-semibold text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 \
    aria-[current=page]:text-indigo-600 dark:aria-[current=page]:text-indigo-400";
// --- Detail modal rows ---
pub const CLASS_DETAIL_DIVIDER: &str = "space-y-0 divide-y divide-gray-100 dark:divide-gray-700";
pub const CLASS_DETAIL_LABEL: &str = "text-sm text-gray-500 dark:text-gray-400";
pub const CLASS_DETAIL_VALUE: &str =
    "text-sm text-gray-900 dark:text-gray-100 font-medium text-right ml-4 truncate max-w-[60%]";
pub const CLASS_DETAIL_VALUE_PLAIN: &str =
    "text-sm text-gray-900 dark:text-gray-100 font-medium text-right ml-4";
pub const CLASS_DETAIL_VALUE_MONO: &str = "text-sm text-gray-900 dark:text-gray-100 font-medium text-right ml-4 truncate max-w-[60%] font-mono";
