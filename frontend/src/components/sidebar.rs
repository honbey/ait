...
pub fn Sidebar() -> impl IntoView {
    view! {
        <aside class="w-56 bg-white dark:bg-ink-900 border-r border-gray-200 dark:border-ink-700 flex flex-col shrink-0">
            ...
            <div class="p-4 border-t border-gray-200 dark:border-ink-700 text-xs text-gray-400 dark:text-ink-500">
